...
export const MASTER_EXERCISES: ExerciseDef[] = [
  ...
  { id: 'incline_dumbell_press', name: 'Incline Dumbbell Press', category: 'Chest', icon: 'dumbbell', type: 'weight' },
  ...
  // --- Arms ---
  { id: 'bicep_curl_dumbbell', name: 'Dumbbell Bicep Curl', category: 'Arms', icon: 'arm-flex-outline', type: 'weight' },
  { id: 'bicep_curl_barbell', name: 'Barbell Bicep Curl', category: 'Arms', icon: 'weight-lifter', type: 'weight' },
  { id: 'hammer_curl', name: 'Hammer Curl', category: 'Arms', icon: 'dumbbell', type: 'weight' },
  { id: 'preacher_curl', name: 'Preacher Curl', category: 'Arms', icon: 'arm-flex', type: 'weight' },
  { id: 'tricep_pushdown', name: 'Tricep Pushdown', category: 'Arms', icon: 'transit-connection-variant', type: 'weight' },
  { id: 'overhead_tricep_extension', name: 'Overhead Tricep Ex', category: 'Arms', icon: 'dumbbell', type: 'weight' },
  { id: 'skull_crusher', name: 'Skull Crusher', category: 'Arms', icon: 'weight-lifter', type: 'weight' },
