...
import { View, Text, StyleSheet, TouchableOpacity, FlatList, ActivityIndicator, Switch, SafeAreaView } from 'react-native';
import { MASTER_EXERCISES, ExerciseDef } from '@/constants/exercises';
